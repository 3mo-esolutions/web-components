...
export class Currency {
	...
	/**
	 * The symbol the given language writes this currency with, falling back to the code itself. Symbols
	 * are language-specific: `CAD` is `$` to a Canadian and `CA$` to everybody else.
	 */
