...
export class Photos extends BusinessSuiteApplication {
	...
	protected get navigations(): Array<INavigation> {
		return [
			new NavigationLink({ icon: 'home', label: 'Home', component: new PagePhotos })
		]
	}
}