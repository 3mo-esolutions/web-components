import { BusinessSuiteApplication, ApplicationLogo, component, type NavigationDefinition, css } from '@3mo/del'
...
export class Photos extends BusinessSuiteApplication {
	...
	protected get navigations(): Array<NavigationDefinition> {
		return [
